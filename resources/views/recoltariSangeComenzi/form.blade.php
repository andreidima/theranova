...
<script type="application/javascript">
    ...
    cereriSangeVechi = {!! json_encode(old('cereriSange', $recoltareSangeComanda->cereri) ?? []) !!}
...
<div class="row mb-0 px-3 d-flex justify-content-evenly border-radius: 0px 0px 40px 40px" id="recoltareSangeComanda">
    ...
    <div class="col-lg-12 px-4 py-2 mb-0">
        <div class="row mb-0 justify-content-around">
            <div class="col-lg-8 px-3 py-3 mb-4 rounded-3" style="background-color: rgb(255, 227, 227)">
                <div class="row mb-0 justify-content-center">
                    <div class="col-lg-12 mb-4 text-center">
                        <h4 class="mb-0 py-1 text-white" style="background-color: rgb(221, 107, 107)">Cerere sânge</h4>
                    </div>
                            ...
                            <table class="table table-striped table-hover rounded">
                                <thead class="text-white rounded">
                                    <tr class="thead-danger" style="padding:2rem">
                                        <th class="text-white" style="background-color: rgb(221, 107, 107)">#</th>
                                        <th class="text-white" style="background-color: rgb(221, 107, 107)">Produs</th>
                                        <th class="text-white" style="background-color: rgb(221, 107, 107)">Grupa</th>
                                        <th class="text-white" style="background-color: rgb(221, 107, 107)">Cantitate</th>
                                        <th class="text-white text-end" style="background-color: rgb(221, 107, 107)">Acțiuni</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="col-lg-12 px-4 py-2 mb-0">
        <div class="row mb-0 justify-content-around">
            <div class="col-lg-5 px-3 py-3 mb-4 rounded-3" style="background-color: rgb(247, 255, 209)">
                ...
                <div v-cloak v-if="recoltariSangeCautate.length" class="row mb-0 justify-content-center">
            ...
            <div class="col-lg-5 px-3 py-3 mb-4 rounded-3" style="background-color: rgb(198, 255, 226)">
                ...
                <div v-cloak v-if="recoltariSangeAdaugateLaComanda.length" class="row mb-0 justify-content-center">
                    <div class="col-lg-12 mb-4">
                        <div class="table-responsive rounded">
                            <table class="table table-striped table-hover rounded">
                                <thead class="text-white rounded">
