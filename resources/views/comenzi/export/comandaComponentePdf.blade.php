    ...
    <main>
        ...
        <div>
            ...
            <table style="">
                ...
                <tr>
                    <td style="border-width:0px; text-align:center;">
                        ...
                        <h2 style="">
                            NUME PACIENT: {{ $comanda->fisaCaz->pacient->nume ?? '' }} {{ $comanda->fisaCaz->pacient->prenume }}
                        </h2>
                        <h2 style="">
                            DATA: {{ $comanda->created_at ? \Carbon\Carbon::parse($comanda->created_at)->isoFormat('DD.MM.YYYY') : '' }}
                        </h2>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 80%; margin-left:auto; margin-right:auto;">
                @foreach ($comanda->componente as $componenta)
                    @if ($loop->first)
                        <tr>
                    ...
                    @endif
                        <tr>
                            ...
                            <td>
                                {{ $componenta->producator }}
                            </td>
                            <td>
                                {{ $componenta->cod_produs }}
                            </td>
                            <td style="text-align:center">
                                {{ $componenta->bucati }}
                            </td>
            ...
            <p style="padding-left:20%">
                TEHNIC: {{ $comanda->fisaCaz->userTehnic->name ?? '' }}
            </p>
