...
<body>
    ...
    <main>
        ...
        <div>
            ...
            @foreach($recoltariSangeGrupatePerCategorieProdus as $recoltariSange)
                @if ($recoltariSange->first()->categorieProdus !== "Rebut recoltare")
                    <div style="page-break-inside:avoid">
                        <h4 style="margin-bottom: 0%; text-align:center">Produse {{ $recoltariSange->first()->categorieProdus ?? '' }}</h4>
                ...
                @elseif ($recoltariSange->first()->categorieProdus === "Rebut recoltare")
                    <div style="page-break-inside:avoid;">
                        <h4 style="margin-bottom: 0%; text-align:center">{{ $recoltariSange->first()->categorieProdus ?? '' }}</h4>
                        <table style="margin:0%; width: 50%; font-size:9px; margin:auto">
                            <thead>
                                <tr>
                                    <th>Data</th>
                                    <th>Nr. rebuturi</th>
