                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item me-3 dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" href="/calendar/mod-afisare-lunar/activitati">
                                        <i class="fa-solid fa-calendar-days me-1"></i>Lunar
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="/calendar/activitati">
                                        <i class="fa-solid fa-calendar-day me-1"></i>Administrare
                                    </a>
                                </li>
                            </ul>
                        </li>
